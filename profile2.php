...
?>
<body style="background-image: url('../matrimony/img/bgwed.jpg'); min-height: 750px; background-size: cover; background-repeat: no-repeat; background-position: center;" class="w-100">
    <?php require(__DIR__ . '/matbase.php'); ?>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="text-start">
                    <img src="../matrimony/img/tek_matrimony_logo.png" width="200px" height="100px" alt="Logo">
                </div>
                <div class="text-end">
                    <center><h5>Great! You have completed <span class="fs-3">20%</span></h5></center>
                </div>
            </div>
        </div>
        <div class="container mt-0" style="background-color: pink; max-width: 1050px; padding: 20px;">
            <div class="row">
                <div class="col-lg-4 mt-5">
                    <img src="../matrimony/img/iml1.jpg" width="330px" height="500px" alt="Image">
                </div>
                <div class="col-lg-8">
                    ...
                    <form>
                        <div class="mb-3">
                            ...
                            <p>Your relative's date of birth helps us find the perfect match.</p>
                        </div>
                        <div class="mb-3">
        ...
        return; // Exit the function if the password is not within the specified length
    }
        ...
        success: function (submit) {
            if (submit === "success") {
                ...
                alert("Email Id Already Exist."); // You can provide an appropriate error message
            }
        },
        error: function () {
