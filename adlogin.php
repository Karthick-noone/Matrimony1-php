    ...
    <style>
       ...
       <header >
          <div class="container-fluid">
              ...
              <img src="img/logo.png" height="30%" width="10%" class="ms-5"></small>
         </div>
     </header>
                             ...
                             <label class="ms-1">
                              <input type="checkbox" > Keep me logged in</label><br><br>
                               <div class="d-grid gap-3 col-xl-6 ms-3">
                                  ...
                                  <a href="passwordpage/password/admin pannel/pages/forms/welcome.php"><button class="btn btn-warning btn-block">Login</button> </a>
