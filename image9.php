        ...
        <div class="row">
            <div class="bg-primary-subtle p-3">
                ...
                <div class="nav-scroller">
                    <img src="../matrimony/img/tek_matrimony_logo.png"
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xl-12 a1 w-100"
                        style="background-image: url('../matrimony/img/6206886.jpg'); min-height: 900px; background-size: cover; background-repeat: no-repeat; background-position: center;">




                        <div class="col-lg-12 col-xl-12">
                            <h2 style="color:darkgray ; padding-top: 10px;" class="display-6 mb-5">
                            ...
                            <center>
                                <div class="col-lg-6 col-xl-6 d-flex"
                                    ...
                                    <p style=" white-space: wrap;margin-left: 15px"> Whatsapp your photos to
                                        <b>+91-000000000</b> & we will upload<br>
                                        them instantly.
                                    </p>
                                </div>
                            </center>
