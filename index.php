...
<button class="btn remov"  onclick="rem()" id="rmv"><img src="img/remove.png" width="20px"></button>
    ...
    <div style="background-image: url('../matrimony/img/img7.jpg'); min-height: 700px; background-size: cover; background-repeat: no-repeat; background-position: center;" class="w-100">
            ...
            <div class="pic">
                <div class="row">
                    <div class="col-md-6 mt-5 ms-3 d-flex">
                        <img src="../matrimony/img/tek_matrimony_logo.png" style="background-color: transparent; width:250px";/>
    ...
    Login
           ...
           <center><div id="message" class="text-center "></div></center>
                    ...
                    <div class="col-md">
                        <div class="form-floating">
                            <select class="form-select bg-secondary-subtle" id="gen">
                                <option disabled>Enter Gender</option>
            ...
            <div class="abc" style="white-space: nowrap;">
              <center> <p class="bgcolor1">By clicking register free, I agree to the <span class="text-dark"><a href="privacy.php">T&C</span></a> and <span class="text-dark"><a href="privacy.php">Privacy Policy</a></span>.</p></center> 
            </div>
    ...
    <script>
    // Get the profile and gender select elements
    const profileSelect = document.getElementById("pro");
    const genderSelect = document.getElementById("gen");

    // Function to set the default gender based on the selected profile
    function setDefaultGender() {
        const selectedProfile = profileSelect.value;
        genderSelect.disabled = false; // Enable the gender select first

        if (selectedProfile === "Brother" || selectedProfile === "Son") {
            genderSelect.value = "Male";
            genderSelect.querySelector('option[value="Female"]').disabled = true;
        } else if (selectedProfile === "Sister" || selectedProfile === "Daughter") {
    ...
    profileSelect.addEventListener("change", setDefaultGender);

    // Call the function initially to set the default gender
    setDefaultGender();
</script>
    <script>
