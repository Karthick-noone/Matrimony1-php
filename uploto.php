...
<div class="container-fluid">
    <div class="row bg-primary-subtle hd">
      <div class="nav-scroller mb-3 mt-3">
        ...
        <nav class="nav float-end" style="">
          <a href="view11.php"> <button class="m-3 btnnn"><img src="img/left-arrows.png" width="20px" alt="">
          Back</button> </a>
        ...
        <div class="nav">
        <a href="view11.php" style="text-decoration:none;"> <button id="nvbtn" class="m-3 btnnn2"><img src="img/left-arrows.png" width="20px" alt="">
          Back</button> </a>
  ...
  <div class="row">
      ...
      <div class=" col-md-3 d-flex">
          <div>
          <img class="rounded-circle  mx-2" src="img/<?php print $sss2['picture']; ?>"  alt="" width="40px" height="40px" style="border-radius: 5px;" >
    </div>
    <div><h4 class="my-2 mx-2"><?php print $sss2['name']; ?></h4></div>
        ...
        <a href="uploto1.php"> <img src="img/icons8-photo-editor-50.png" width="20px">&nbsp;&nbsp;Edit Photo</a>
                    ...
                    <div class="col-lg-12 col-md-12 col-xl-12 m-3 rounded"
                        style="background-image: url('../matrimony/img/6206886.jpg'); min-height: 700px; background-size: cover; background-repeat: no-repeat; background-position: center; width:80%;">




                        <div class="col-lg-12 col-xl-12">
                            <h2 style="color: #3c091c ; padding-bottom: 50px;" class="display-6 mb-5">
